...
function Chat() {
  ...
  useEffect(() => {
    socket.current = io(process.env.BACKENDURL || "https://mungaireactbackend.herokuapp.com")
  ...
  function handleSubmit(e) {
    ...
    setState(draft => {
      draft.chatMessage.push({ username: appState.user.username, message: state.fieldValue, avatar: appState.user.avatar })
      draft.fieldValue = ""
    })
  }
  return (
