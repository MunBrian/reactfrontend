    ...
    <Page title="Welcome!" wide={true}>
      <div className="row align-items-center">
        <div className="col-lg-7 py-3 py-md-5">
          <h1 className="display-3">React Blog App</h1>
          <p className="lead text-muted">A simple react blog app. SignUp for an account, create and post your ideas or posts, follow some of your friends and chats with them. </p>
        </div>
